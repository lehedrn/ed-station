        ...
        <el-col :span="24">
          <basic-container>
            <el-collapse v-model="logActiveNames" @change="handleChange">
              <el-collapse-item
                title="4.8.0.RELEASE发布，新增超级令牌认证，新增签名防重放攻击，新增请求规则配置"
                name="44"
              >
                <div>1.[升级]SpringBoot 至 3.5.9</div>
                <div>2.[升级]SpringCloud 至 2025.0.1</div>
                <div>3.[升级]AlibabaCloud 至 2025.0.0.0</div>
                <div>4.[升级]Nacos 至 3.1.1</div>
                <div>5.[新增]自定义超级令牌认证</div>
                <div>6.[新增]签名认证支持nonce参数的防重放攻击</div>
                <div>7.[新增]请求方法规则配置，可灵活配置不同接口的方法类型</div>
                <div>8.[新增]安全框架认证测试类，便于一键调试</div>
                <div>9.[重构]个人中心模块</div>
                <div>10.[优化]Minio上传支持超大型文件</div>
                <div>11.[优化]升级Minio Client版本，避免内置依赖冲突</div>
                <div>12.[优化]Ureport导出代码逻辑适配高版本依赖</div>
                <div>13.[优化]Mybatis-Plus拦截器加载顺序</div>
                <div>14.[优化]动态数据源加载逻辑</div>
                <div>15.[优化]附件上传逻辑</div>
                <div>16.[优化]附件模块删除功能</div>
                <div>17.[优化]代码生成器数据加载逻辑</div>
                <div>18.[优化]租户产品包树形菜单的交互体验</div>
                <div>19.[优化]取消登录界面的角色自动切换弹窗，改为手动切换逻辑</div>
                <div>20.[优化]字典查询排序逻辑</div>
                <div>21.[优化]用户修改接口逻辑</div>
                <div>22.[修复]根据部门查询用户时未过滤已删除数据的问题</div>
                <div>23.[修复]OSS复制文件接口</div>
                <div>24.[修复]Antlr4依赖兼容性问题</div>
                <div>25.[修复]角色管理未正确处理提交数据的问题</div>
                <div>26.[修复]租户背景图绑定失效的问题</div>
              </el-collapse-item>
              <el-collapse-item
